...
public class ApiClient {
    ...
    public static Retrofit getRetrofit(BaseUrlEnum baseUrlEnum) {
        ...
        if (baseUrlEnum.getValue() == 1) {
            baseUrl = "http://192.168.18.160:8080/usuario/"; /* coloca tu ip */
        } else if (baseUrlEnum.getValue() == 2) {
            baseUrl = "http://192.168.18.160:8080/notas/"; /* coloca tu ip */
        } else if (baseUrlEnum.getValue() == 3) {
            baseUrl = "http://192.168.18.160:8080/categoria/"; /* coloca tu ip */
        } else {
